...
# aspect_embedding = Embedding(MAX_NUM_ASPECT_WORDS, EMBEDDING_DIM, mask_zero=MASK_ZEROS, trainable=True) # this needs to be True
...
NUM_CELLS = 64
x = LSTM(NUM_CELLS, return_sequences=True)(sentence_embedding)
